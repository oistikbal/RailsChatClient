...
{
    /// <summary>
    /// Transforms a Vector3 value by returning either the x, y or z component as a float with the option to round to a specified number of decimal places.
    /// </summary>
    [CreateAssetMenu(fileName = "Vector3 to Float", menuName = "Doozy/Bindy/Transformer/Vector3 to Float", order = -950)]
    public class Vector3ToFloatTransformer : ValueTransformer
    {
        ...
        [SerializeField] private Axis3D Axis = Axis3D.X;
        /// <summary>
        /// The axis to use when formatting the Vector3 value.
        /// </summary>
        public Axis3D axis
        {
            get => Axis;
