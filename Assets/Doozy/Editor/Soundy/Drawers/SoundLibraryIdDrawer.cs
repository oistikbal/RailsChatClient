...
{
    [CustomPropertyDrawer(typeof(SoundLibraryId), true)]
    public class SoundLibraryIdDrawer : AudioLibraryIdDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            var id = property.GetTargetObjectOfProperty() as SoundLibraryId;
