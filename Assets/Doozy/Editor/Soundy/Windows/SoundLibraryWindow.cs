...
{
    public class SoundLibraryWindow : FluidWindow<SoundLibraryWindow>
    {
        private const string k_WindowTitle = "Sound Libraries";
        
        public static void Open() => InternalOpenWindow(k_WindowTitle);
        
        protected override void CreateGUI()
        {
            windowLayout = new SoundLibraryRegistryWindowLayout();
        ...
        public SoundLibraryWindow SelectLibrary(string libraryName)
        {
            SoundLibraryRegistryWindowLayout layout = (SoundLibraryRegistryWindowLayout)windowLayout;
