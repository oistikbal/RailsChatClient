...
{
    public class MusicObjectPopupWindow : EditorWindow
    {
        private const string k_WindowTitle = "Music Object";

        public static MusicObjectPopupWindow Open() =>
            GetWindow<MusicObjectPopupWindow>(true, k_WindowTitle, true);
        ...
        public MusicObjectPopupWindow LoadAsset(Object target)
        {
