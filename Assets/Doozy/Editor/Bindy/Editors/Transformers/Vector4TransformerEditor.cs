...
{
    [CustomEditor(typeof(Vector4Transformer), true)]
    public class Vector4TransformerEditor : ValueTransformerEditor
    {
        ...
        private SerializedProperty propertyRoundW { get; set; }
        ...
        protected override void FindSerializedProperties()
        {
            ...
            propertyRoundW = serializedObject.FindProperty("RoundW");
        ...
        protected override void InitializeCustomInspector()
        {
            ...
            FluidToggleCheckbox roundXToggle =
                FluidToggleCheckbox.Get()
                    ...
                    .SetLabelText("X")
                    .SetTooltip("Round the x component of the Vector4 value to the specified number of decimal places");
            ...
            FluidToggleCheckbox roundYToggle =
                FluidToggleCheckbox.Get()
                    ...
                    .SetToggleAccentColor(selectableAccentColor)
                    .SetLabelText("Y")
                    .SetTooltip("Round the y component of the Vector4 value to the specified number of decimal places");
            ...
            FluidToggleCheckbox roundZToggle =
                FluidToggleCheckbox.Get()
                    ...
                    .SetToggleAccentColor(selectableAccentColor)
                    .SetLabelText("Z")
                    .SetTooltip("Round the z component of the Vector4 value to the specified number of decimal places");

            FluidToggleCheckbox roundWToggle =
                FluidToggleCheckbox.Get()
                    .BindToProperty(propertyRoundW)
                    .SetToggleAccentColor(selectableAccentColor)
                    .SetLabelText("W")
                    .SetTooltip("Round the w component of the Vector4 value to the specified number of decimal places");
                ...
                FluidField.Get()
                    ...
                    (
                        DesignUtils.row
                            ...
                            .AddSpaceBlock()
                            .AddChild(roundWToggle)
                    );

            TextField displayFormatField =
                DesignUtils.NewTextField(propertyDisplayFormat)
                    .SetStyleFlexGrow(1)
                    .SetTooltip("The display format of the Vector4 value. Use the following placeholders: {0} = x component, {1} = y component, {2} = z component, {3} = w component");
