    ...
    public partial class FlowNodeView
    {
        public static FlowNodeView GetView(FlowGraphView graphView, FlowNode node) =>
            node switch
            {
                ...
                Doozy.Runtime.Soundy.Nody.Nodes.MusicNode _ => new Doozy.Editor.Soundy.Nody.Nodes.MusicNodeView(graphView, node),
                Doozy.Runtime.Soundy.Nody.Nodes.SoundNode _ => new Doozy.Editor.Soundy.Nody.Nodes.SoundNodeView(graphView, node),
