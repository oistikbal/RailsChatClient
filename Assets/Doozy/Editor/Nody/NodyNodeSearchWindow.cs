    ...
    public class NodyNodeSearchWindow : ScriptableObject, ISearchWindowProvider
    {
        ...
        public List<SearchTreeEntry> CreateSearchTree(SearchWindowContext context)
        {
            var tree = new List<SearchTreeEntry>()
            {
                ...
                new SearchTreeGroupEntry(new GUIContent("Soundy"), 1),
                new SearchTreeEntry(new GUIContent("Music", transparentIcon)) { userData = new NodeTypeInfo(typeof(Doozy.Runtime.Soundy.Nody.Nodes.MusicNode)), level = 2 },
                new SearchTreeEntry(new GUIContent("Sound", transparentIcon)) { userData = new NodeTypeInfo(typeof(Doozy.Runtime.Soundy.Nody.Nodes.SoundNode)), level = 2 },
        ...
        public bool OnSelectEntry(SearchTreeEntry searchTreeEntry, SearchWindowContext context)
        {
            ...
            if(nodeInfo.type == typeof(Doozy.Runtime.Soundy.Nody.Nodes.MusicNode)) { graphView.CreateNode(typeof(Doozy.Runtime.Soundy.Nody.Nodes.MusicNode), true); return true;}
            if(nodeInfo.type == typeof(Doozy.Runtime.Soundy.Nody.Nodes.SoundNode)) { graphView.CreateNode(typeof(Doozy.Runtime.Soundy.Nody.Nodes.SoundNode), true); return true;}
